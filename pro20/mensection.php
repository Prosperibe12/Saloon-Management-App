  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-3" id="services" style="background-color:white;">
          <div class="Beauty">
            <a href="hairstyles.php" class="sidebars" id="feature">Hair Styles</a>
          </div>
          <div class="Beauty" style="background-color: #FE7F9B;"><a href="mensection.php" class="sidebars" id="feature" style="color:white">Men's Care</a></div>
      </div>
    <div class="col-lg-9">
        <h3 style="color:#FE7F9B">Men's Care</h3>
        <!-- Card Bodies -->
        <div class="row row-cols-1 row-cols-md-3 g-4">
          <?php 
            // instantiating class
            $objMen = new SaloonManagement;
            $showMen = $objMen->menSection();
